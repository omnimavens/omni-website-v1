    ...
    <section class="hero-section">
        <div class="container">
            <div data-aos="fade-up">
                <span class="section-subtitle">Full-Service Digital Growth</span>
                <h1 class="hero-h1">
                    Data-Led Strategy. <br> <span class="text-accent">Revenue-Driven</span> Results.
                </h1>
                <p class="hero-sub">
        ...
        <div class="marquee-container">
            <div class="marquee-content">
                <span class="marquee-item"><span>•</span> SEO & Local Search</span>
                <span class="marquee-item"><span>•</span> GEO & AI Optimization</span>
                <span class="marquee-item"><span>•</span> Google Ads (PPC)</span>
                <span class="marquee-item"><span>•</span> Social Media Growth</span>
                <span class="marquee-item"><span>•</span> Email Automation</span>
                <span class="marquee-item"><span>•</span> Content Marketing</span>
        ...
        <div class="container">
            <div class="about-flex">
                ...
                <div style="flex:1;" data-aos="fade-left">
                    ...
                    <p style="color: #aaa; margin-bottom: 20px; font-size: 18px;">
                        Omni Mavens is a collective of strategists, creatives, and engineers. We believe that the best marketing sits at the intersection of <strong>data science</strong> and <strong>human psychology</strong>.
                    </p>
        ...
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: end; flex-wrap: wrap; gap: 20px;">
                <div data-aos="fade-right">
                    <span class="section-subtitle">Business Outcomes</span>
                    <h2>What is your primary goal?</h2>
                </div>
                
            </div>

            <div class="sol-grid-home">
                
                <div class="sol-card-home" data-aos="fade-up" data-aos-delay="0">
                    <div class="sol-icon-home"><i class="fa-solid fa-eye"></i></div>
                    <div>
                ...
                <div class="sol-card-home" data-aos="fade-up" data-aos-delay="100">
                    <div class="sol-icon-home"><i class="fa-solid fa-users"></i></div>
                    <div>
                ...
                <div class="sol-card-home" data-aos="fade-up" data-aos-delay="200">
                    <div class="sol-icon-home"><i class="fa-solid fa-magnet"></i></div>
                    <div>
                ...
                <div class="sol-card-home" data-aos="fade-up" data-aos-delay="300">
                    <div class="sol-icon-home"><i class="fa-solid fa-chart-line"></i></div>
                    <div>
                ...
                <div class="sol-card-home" data-aos="fade-up" data-aos-delay="400">
                    <div class="sol-icon-home"><i class="fa-solid fa-crown"></i></div>
                    <div>
    ...
    <section class="faq-section d-none">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <h2 style="font-size: 40px; text-transform: uppercase;">Agency FAQ</h2>
            </div>
