                ...
                <div class="uni-form-card" data-aos="fade-left">
                    <form action="#" method="POST">
                        <div class="uni-group">
                            ...
                            <input type="url" class="uni-input" placeholder="https://yourcompany.com" required>
                        </div>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                            <div>
                                <label class="uni-label">Name <span style="color:#E08322">*</span></label>
                                <input type="text" class="uni-input" placeholder="Your Name" required>
                            </div>
                            <div>
                                <label class="uni-label">Work Email <span style="color:#E08322">*</span></label>
                                <input type="email" class="uni-input" placeholder="name@company.com" required>
                            </div>
                        </div>

                        <div class="uni-group">
                            <label class="uni-label">Primary Goal</label>
                            <select class="uni-select" style="cursor: pointer;">
                        ...
                        <div class="uni-group">
                            ...
                            <textarea class="uni-textarea" placeholder="Briefly describe your challenges or goals..."></textarea>
                        </div>
